                ...
                colModel: [
                    ...
                    {name: "password", editable: true, width: 90, align: "left"},
                    {
                        ...
                        formatter: function (cellvalue, option, row) {
                            return "<button class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='show(\"" + row.id + "\",\"" + cellvalue + "\")'>查看信息</button>" +
...
<div class="panel panel-danger">
    ...
    <div class="panel panel-body">
        <button type="button" id="btn1" class="btn btn-success">导出员工信息</button>&emsp;
    </div>
...
<!--初始化表单-->
<table id="userlist" class="success"></table>
<!--定义分页工具栏-->
